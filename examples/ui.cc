...
cli::terminal_nodes example_ui() {
  return cli::terminal_nodes{
    /*
      Page Title
    */
    ...
    cli::terminal_node::text("An Example User Interface"),
    cli::terminal_node::format_end(),
    cli::terminal_node::new_line(),
    /*
      Paragraph of Contents
    */
    cli::terminal_node::text(
